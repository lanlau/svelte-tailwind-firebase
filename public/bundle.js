...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*user*/ 1 && t0_value !== (t0_value = /*user*/ ctx[0].email + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file, 20, 6, 529);
    ...
    ***************************************************************************** */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 25, 10, 739);
    			...
    			add_location(input0, file$2, 29, 16, 956);
    			attr_dev(div0, "class", "flex flex-col mt-4");
    			add_location(div0, file$2, 28, 14, 907);
    			...
    			add_location(input1, file$2, 39, 16, 1318);
    			attr_dev(div1, "class", "flex flex-col mt-4");
    			add_location(div1, file$2, 38, 14, 1269);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "bg-blue-500 hover:bg-blue-700 text-white text-sm\n                  font-semibold py-2 px-4 rounded");
    			add_location(button, file$2, 49, 16, 1696);
    			attr_dev(div2, "class", "flex flex-col mt-8");
    			add_location(div2, file$2, 48, 14, 1647);
    			attr_dev(form, "class", "form-horizontal w-3/4 mx-auto");
    			add_location(form, file$2, 27, 12, 848);
    			attr_dev(a, "class", "no-underline hover:underline text-blue-dark text-xs");
    			attr_dev(a, "href", "/");
    			add_location(a, file$2, 59, 14, 2060);
    			attr_dev(div3, "class", "text-center mt-4");
    			add_location(div3, file$2, 58, 12, 2015);
    			attr_dev(div4, "class", "w-full mt-4");
    			add_location(div4, file$2, 26, 10, 810);
    			attr_dev(div5, "class", "flex flex-col flex-1 justify-center mb-8");
    			add_location(div5, file$2, 24, 8, 674);
    			attr_dev(div6, "class", "flex flex-col w-full md:w-1/2 p-4");
    			add_location(div6, file$2, 23, 6, 618);
    			attr_dev(div7, "class", "hidden md:block md:w-1/2 rounded-r-lg");
    			set_style(div7, "background", "url('https://images.unsplash.com/photo-1515965885361-f1e0095517ea?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=3300&q=80')");
    			set_style(div7, "background-size", "cover");
    			set_style(div7, "background-position", "center center");
    			add_location(div7, file$2, 68, 6, 2292);
    			attr_dev(div8, "class", "flex rounded-lg shadow-lg w-full sm:w-3/4 lg:w-1/2 bg-white sm:mx-0");
    			set_style(div8, "height", "500px");
    			add_location(div8, file$2, 20, 4, 496);
    			attr_dev(div9, "class", "flex flex-col items-center flex-1 h-full justify-center px-4 sm:px-0");
    			add_location(div9, file$2, 18, 2, 405);
    			attr_dev(div10, "class", "bg-blue-400 h-screen w-screen");
    			add_location(div10, file$2, 17, 0, 359);
    ...
    const file$5 = "src/routes/protected/sessions/sessions.svelte";
    ...
    const file$6 = "src/routes/protected/session/session.svelte";
    ...
    const file$7 = "src/routes/protected/routes.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(router.$$.fragment);
    			add_location(h1, file$7, 14, 0, 331);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$8 = "src/routes/routes.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$8, 46, 2, 1274);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(49:2) {#if $location !== '/signin'}",
    		ctx
    	});
