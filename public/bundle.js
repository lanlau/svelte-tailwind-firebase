    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 19, 4, 552);
    			attr_dev(div1, "class", "block lg:hidden");
    			add_location(div1, file, 18, 2, 518);
    			attr_dev(div2, "class", "text-sm lg:flex-grow");
    			add_location(div2, file, 32, 4, 1016);
    			add_location(div3, file, 50, 4, 1478);
    			attr_dev(div4, "class", "w-full block flex-grow lg:flex lg:items-center lg:w-auto");
    			add_location(div4, file, 31, 2, 941);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i, "class", "material-icons fill-current mr-2");
    			set_style(i, "font-size", "300px");
    			add_location(i, file$2, 69, 8, 2370);
    			attr_dev(div7, "class", "hidden md:block md:w-1/2 rounded-r-lg flex items-center");
