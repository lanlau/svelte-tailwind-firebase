    ...
    ***************************************************************************** */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "/");
    			add_location(a, file$3, 59, 14, 2059);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(50:2) {#if $location !== '/signin'}",
    		ctx
    	});
